...
void main() {
    ...
    //vec4 diffuse_environment = textureLod(environment_map, corrected_normal, 5) * 1.3;
    vec4 diffuse_environment = averageCube(environment_map, corrected_normal, 2);
    diffuse_environment = textureLod(environment_map, corrected_normal, 7);
