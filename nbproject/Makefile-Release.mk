...
${OBJECTDIR}/mo/Mesh.o: mo/Mesh.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mo/Mesh.o mo/Mesh.cpp

${OBJECTDIR}/mo/Model.o: mo/Model.cpp 
	${MKDIR} -p ${OBJECTDIR}/mo
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mo/Model.o mo/Model.cpp

${OBJECTDIR}/mo/Renderer.o: mo/Renderer.cpp 
	${MKDIR} -p ${OBJECTDIR}/mo
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mo/Renderer.o mo/Renderer.cpp

${OBJECTDIR}/mo/Texture2D.o: mo/Texture2D.cpp 
	${MKDIR} -p ${OBJECTDIR}/mo
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mo/Texture2D.o mo/Texture2D.cpp
