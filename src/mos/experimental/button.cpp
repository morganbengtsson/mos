...
Button::Button(const Text &text, const State &s)
    : text_(text), padding_(text_.height() / 4.0f),
      light_material_(glm::vec3(0.0f), glm::vec3(1.0f), glm::vec3(0.0f), glm::vec3(0.0f), 0.8f),
      dark_material_(glm::vec3(0.0f), glm::vec3(0.01f), glm::vec3(0.0f), glm::vec3(0.0f), 0.8f) {
