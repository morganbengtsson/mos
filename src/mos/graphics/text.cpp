...
namespace mos {
    ...
    void Text::text(const std::string & text) {
        ...
        for (const char & c : text_) {
            ...
            model_.mesh->add(Vertex(glm::vec3(index + offset_x,
                                              rect_h + offset_y,
                                              0.0f), glm::vec3(0.0f), glm::vec2(u1, v2)));
            model_.mesh->add(Vertex(glm::vec3(index + character.rect_w + offset_x,
                                              offset_y,
                                              0.0f), glm::vec3(0.0f), glm::vec2(u2, v1)));
            model_.mesh->add(Vertex(glm::vec3(index + offset_x,
                                              offset_y,
                                              0.0f), glm::vec3(0.0f), glm::vec2(u1, v1)));
            model_.mesh->add(Vertex(glm::vec3(index + offset_x,
                                              rect_h + offset_y,
                                              0.0f), glm::vec3(0.0f), glm::vec2(u1, v2)));
            model_.mesh->add(Vertex(glm::vec3(index + character.rect_w + offset_x,
                                              rect_h + offset_y,
                                              0.0f), glm::vec3(0.0f), glm::vec2(u2, v2)));
            model_.mesh->add(Vertex(glm::vec3(index + character.rect_w + offset_x,
                                              offset_y,
                                              0.0f), glm::vec3(0.0f), glm::vec2(u2, v1)));
    ...
    glm::vec2 Text::position() {
         return glm::vec2(model_.position());
    }
