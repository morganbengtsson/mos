...
void main() {
    ...
    vec3 temp = material.albedo.rgb * (lights[0].color + lights[1].color);

    vec3 ambient = vec3(0.0, 0.0, 0.0);
    ambient.x = log(pow(temp.x, 42)) - 80.0f;
    ambient.y = log(pow(temp.y, 42)) - 80.0f;
    ambient.z = log(pow(temp.z, 42)) - 80.0f;
